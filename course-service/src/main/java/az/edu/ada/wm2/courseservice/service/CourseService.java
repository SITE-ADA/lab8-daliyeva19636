...
public class CourseService {
    ...
    public EnrollmentResponseDto enrollStudent(Long courseId, Long studentId) {
        ...
        if (targetCourse.getPrerequisiteCourseId() != null) {
            ...
            if (!hasCompletedPrereq) {
                throw new PrerequisiteNotMetException(courseId, prereqId);
            }
        }
    ...
    public CourseStudentsResponseDto getCourseStudents(Long courseId) {
        ...
        List<CourseStudentsResponseDto.EnrolledStudentDto> enrolledStudents = enrollments.stream()
                .map(enrollment -> {
                    StudentDto studentDetails = fetchStudentWithRestTemplate(enrollment.getStudentId());
                    return new CourseStudentsResponseDto.EnrolledStudentDto(
                            studentDetails,
        ...
        return new CourseStudentsResponseDto(course.getId(), course.getTitle(), enrolledStudents);
    }
